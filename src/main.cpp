...
uint256 hashGenesisBlock("0x4bd82710a70a0c143283b5244b209761ba6ce9fa95ef57cd73d4fa542f5c9ff3");
...
const string strMessageMagic = "nfycoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // nfycoin: 1 days
static const int64 nTargetSpacing = 120; // nfycoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal nfycoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "nfycoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4bd82710a70a0c143283b5244b209761ba6ce9fa95ef57cd73d4fa542f5c9ff3");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Building a coin for Nullify.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1386382750; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 278169;

        if (fTestNet)
        {
            block.nTime    = 1386359922;
            block.nNonce   = 641419;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x64434fccb6ac4247c3b144a0a9341c19280e8f5e720d418f6ba1a82fb17ec08e"));
